...
const SecondRoute = (props) => {
    ...
    <Text style={{ alignSelf:'center',  fontSize: 24, fontWeight:'bold', color: 'white', }}>{props.route.title}</Text>
    </View>
                        ...
                        {item.hasOwnProperty('groupOrder') ?
                            ...
                            <View style={
                                ...
                                <View style={
                                    ...
                                    <Text style={exampleStyle.orderlistPastTime}>   
                                                {  
                                                //     console.log(item.orderInfo.pickupTime),
                                                //    console.log(new moment(item.orderInfo.pickupTime,"HH:mm:ss")),
                                                //    console.log(new moment(item.date + item.orderInfo.orderTime,"YYYY_MM_DD HH:mm:ss")),
